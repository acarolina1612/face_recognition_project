...
class FaceFeature(object):
    def __init__(self, face_rec_graph, model_path = os.path.join('models', '20170512-110547.pb')):
        '''
    ...
    def __load_model(self, model):
        ...
        model_exp = os.path.join(os.path.dirname(os.path.abspath(__file__)), model)
